...
namespace APIVerve
{
    public class RandomWordAPIClient
    {
        ...
        public RandomWordAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public RandomWordAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, randomwordsQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(randomwordsQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(randomwordsQueryOptions options)
        {
